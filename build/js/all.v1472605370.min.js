...
var locs={"Buenos Aires":"-36.272988,-60.346513",CABA:"-34.615714, -58.5035323","Ciudad Autónoma de Buenos Aires":"-34.6153711,-58.5737519",Mendoza:"-33.837789,-68.557024","Santa Fe":"-29.773540, -60.690089",Chubut:"-43.89275,-68.579102","Córdoba":"-31.597581, -63.903979","Rio Negro":"-40.493018, -68.615712","Río Negro":"-40.493018, -68.615712","Tucumán":"-26.938320, -65.381922","Entre Rios":"-32.075015, -59.299457","Entre Ríos":"-32.075015, -59.299457","La Pampa":"-37.220522, -65.871430","La Rioja":"-29.631108, -67.135729",Jujuy:"-22.832761, -66.145428","Neuquén":"-38.600003, -70.058093","Santiago del Estero":"-27.703326, -63.466296",Chaco:"-26.618343, -60.664782",Catamarca:"-27.088818, -67.190661",Corrientes:"-28.729470, -57.775378",Formosa:"-24.777111, -60.159411","San Luis":"-33.861615, -66.081042",Misiones:"-26.936507, -54.580919","Tierra del Fuego":"-54.237850, -67.744698",Salta:"-25.204840, -64.805456","San Juan":"-31.099886, -68.881384","Santa Cruz":"-48.877868, -70.332708"};$(function(){var a={content:"viz"},r=new MapChart(a);d3.csv("data/data.csv",function(a,t){function e(){y.update(),B.update(),R.update(),S.update(),T.update()}var n=_.groupBy(t,"Provincia"),o=_.groupBy(t,"año"),u=_.groupBy(t,"porquienRegular"),i=_.groupBy(t,"comoRegular"),s=_.groupBy(t,"embarazada"),l=_.groupBy(t,"Mes"),v=[];for(var d in n)if("Exterior"!=d&&locs[d]){var p={name:d,data:n[d],total:n[d].length,lat:locs[d].split(",")[0],lon:locs[d].split(",")[1]};v.push(p)}r.pushData(v),r.update_bounding_map();var c=[];for(var h in o){var g={name:h,total:o[h].length,data:o[h]};c.push(g)}var m={content:"#by_year_bars",axis:"value"},B=new BarChart(c,m),C=[];for(var h in u){var g={name:h,total:u[h].length,data:u[h]};C.push(g)}var f={content:"#by_porquien",axis:"value"},y=new BarChart(C,f),b=[];for(var h in i){var g={name:h,total:i[h].length,data:i[h]};b.push(g)}var w={content:"#comoRegular",axis:"value"},R=new BarChart(b,w),x=[];for(var h in s){var g={name:h,total:s[h].length,data:s[h]};x.push(g)}var z={content:"#embarazada",axis:"value"},S=new BarChart(x,z),A=[];for(var h in l){var g={name:h,total:l[h].length,data:l[h]};A.push(g)}var E,M={content:"#mes",axis:"value"},T=new BarChart(A,M);window.onresize=function(a){clearTimeout(E),E=setTimeout(e,200)}})});